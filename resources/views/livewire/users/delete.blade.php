                ...
                <div class="px-4 py-5 space-y-6 sm:p-6">
                    <div class="grid grid-cols-3 gap-6">
                        <div class="form-group col-span-3 sm:col-span-2">
                            <input type="hidden" wire:model="slug" class="delete_id">
                        </div>
                        <div class="form-group col-span-3 sm:col-span-2">
                            <input disabled type="text" class="form-control focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" wire:model="name" id="name" placeholder="Enter name">
                            @error('name') <span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group col-span-3 sm:col-span-2">
                            <input disabled type="email" class="form-control focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" wire:model="email" id="email" placeholder="Enter Email">
